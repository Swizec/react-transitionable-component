    ...
    _createClass(TransitionableComponent, [{
        ...
        value: function componentWillReceiveProps(newProps) {
            ...
            transition.on('end', function () {
                return _this2.setState(newProps);
            });
        }
    }]);
...
console.log('type transitionablecomp', typeof TransitionableComponent === 'undefined' ? 'undefined' : _typeof(TransitionableComponent));
...
var _TransitionableComponent = require('./TransitionableComponent');

Object.defineProperty(exports, 'TransitionableComponent', {
  enumerable: true,
  get: function get() {
    return _TransitionableComponent.TransitionableComponent;
  }
});
